...
//Controls
draw_text(700,50, "Joystick = Movement (On Arcade)");
draw_text(700,100, "Left = Dash (When Green Gobbler)");
draw_text(700,150, "Left = Slide (When Lean Man) (On Keyboard & Mouse)");
draw_text(700,200, "Shift = Exit (When In Spaceship) (On Keyboard & Mouse)");
draw_text(700,250, "Right Click = Grapple (When In Spaceship)(On Keyboard & Mouse)");
draw_text(700,300, "Other Controls:");
draw_text(700,350, "2 = Interact");
draw_text(700,400, "Left Click = Shoot (When Player/In Spaceship) (On Keyboard & Mouse)");
draw_text(700,450, "Left = Attack (When Player)");
draw_text(700,500, "Hold Right To Begin!");